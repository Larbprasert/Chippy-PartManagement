...
<body class="${bodySkin}">
	...
	<div class="content-wrapper yung">
		...
		<section class="content-header">
			<h1>
				<i class="fa fa-industry"></i>&nbsp;&nbsp;Fire Fighting Equipment Request
			</h1>
		</section>
		<!--ค้นหา  -->
								...
								<form class="form-horizontal" id="myForm" commandname="sysParam"
									...
									<div class="row"
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group">
													<label for="paramCode" class="col-lg-4 control-label">ผู้อนุมัติ:
													</label>
													<div class="col-lg-6">
														<input type='text' class="form-control" />
													</div>
											...
											<div class="col-lg-6">
												<div class="form-group">
													<label for="paramCode" class="col-lg-4 control-label">วันที่อนุมัติ:</label>
													<div class="col-lg-6">
														<input type='text' class="form-control" /> </span>
													</div>
												</div>
											...
											<div class="col-lg-6 text-right">
												...
												<button type="reset" class="btn btn-success">อนุมัติ</button>
