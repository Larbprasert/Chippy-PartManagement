...
<body class="${bodySkin}">
	...
	<div class="content-wrapper">
		<section class="content-header">
			<h3>
				<i class="fa fa-fire"></i> Fire Fighting Equipment Certificate 
			</h3>
		</section>
							...
							<tr>
								...
								<td align="center">
									<button type="button" onclick="popupDescription()"
										...
										<i class="fa fa-edit fa-lg"></i>Certificate
									</button>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fa fa-edit"></i>Fire Fighting Equipment Certificate
					</h4>
				</div>
								...
								<table class="table table-striped ">
									...
									<tbody>
										<tr>
											...
											<td>02/06/2018</td>
											<td>562K</td>
											<td><button class="btn btn-box-tool  btn-info btn-table">Dowload</button></td>
											<td><button
													class="btn btn-box-tool  btn-warning btn-table">Delete</button></td>
										</tr>
										<tr>
											<td>2.</td>
											<td>เอกสารคู่มือ.pdf</td>
											<td>02/06/2018</td>
											<td>562K</td>
											<td><button class="btn btn-box-tool  btn-info btn-table">Dowload</button></td>
											<td><button
