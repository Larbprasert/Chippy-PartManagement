...
<body class="${bodySkin}">
	...
	<div class="content-wrapper">
		<section class="content-header">
			<h3>
				<i class="fa fa-list"></i>Fire Fighting Equipment Request List
			</h3>
						...
						<tbody>
							...
							<tr>
								...
								<td><button type="button"
										onclick="window.location.href='ffe_received_detail.htm'"
										class="btn btn-box-tool  btn-info btn-table">Recieve</button></td>
							</tr>
							<tr>
								<td>xx</td>
								<td>xx</td>
								...
								<td>xx</td>
								<td>xx</td>
								<td style="color: red;">Wait send to vendor</td>
								<td><button type="button"
										onclick="window.location.href='ffe_received_detail.htm'"
										class="btn btn-box-tool btn-info btn-table">Send</button></td>
							</tr>
							<tr>
								<td>xx</td>
								<td>xx</td>
								...
								<td>xx</td>
								<td>xx</td>
								<td>Wait receive from vendor</td>
								<td><button type="button"
										onclick="window.location.href='ffe_received_detail.htm'"
										class="btn btn-box-tool btn-info btn-table">Receive</button></td>
							</tr>
							<tr>
								<td>xx</td>
								<td>xx</td>
