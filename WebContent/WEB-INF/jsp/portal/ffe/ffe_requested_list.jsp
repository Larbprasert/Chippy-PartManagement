				...
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<button type="button"
							...
							onclick="window.location.href='ffe_requested_new.htm'" >
							<i class="fa fa-check-square-o"></i> New Request
						</button>
						<!-- 						<button type="button" class="btn btn-box-tool btn-info btn-table" -->
						<!-- 							onclick="doSendMail()"> -->
						<!-- 							<i class="fa fa-circle-o"></i> Acknowledge -->
						<!-- 						</button> -->
					...
					<table id="result-table"
						...
						<tbody>
							<tr>
								...
								<td>xx</td>
								<td>xx</td>
								<td><button type="button" onclick="window.location.href='ffe_requested_detail.htm'"
										class="btn btn-box-tool btn-warning btn-table">Detail</button></td>
							</tr>
							<tr>
								<td>xx</td>
								<td>xx</td>
