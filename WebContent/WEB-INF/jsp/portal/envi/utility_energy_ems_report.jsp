	...
	function callChart(){
		$.ajax({
        	...
        	for(var x in parsed.data){
        		if (x == 0 ){
        			sum = TDATA.data[x].elecCo2TonVal + TDATA.data[x].steamCo2TonVal + TDATA.data[x].waterCo2TonVal ;
        			dataArr.push(round2Digits((TDATA.data[x].elecCo2TonVal/sum)*100));
        			dataArr.push(round2Digits((TDATA.data[x].steamCo2TonVal/sum)*100));
        			dataArr.push(round2Digits((TDATA.data[x].waterCo2TonVal/sum)*100));
        		}
        	} 
        	loadChart();
