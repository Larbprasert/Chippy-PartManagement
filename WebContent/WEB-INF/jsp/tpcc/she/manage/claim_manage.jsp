		...
		<div class="page-header">
			<div class="row">
				...
				<div class="col-lg-8 col-md-7 col-sm-6">
					<h3><i class='fa fa-wrench'></i> Claim Management</h3>
				</div>
<!-- 				<hr> -->
			</div>
		</div>
...
<div class="bs-docs-section">
        ...
        <div class="row">
          <div class="col-lg-12">
          				<button type="button" class="btn btn-primary" onclick="doAdd()"><i class="fa fa-plus"></i>&nbsp;Manage Claim </button>
		  <br>
		  <br>
		    ...
		    columns: [
		     	...
		     	{ 
			       ...
			       , "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
			    	   var txt = $roleEdit? "<a  href='${cPath}/claim/claimEdit.htm?edit=Y&claimId="+oData.claimId+"'><i class='fa fa-edit fa-lg'></i></a>" : "";
			    	   if($roleEdit&&$roleDel){ txt +=	"&nbsp;|&nbsp;" };
			        	if($roleDel){ txt += "<a href='javascript:void(0)' onclick=\"doDel('"+oData.claimId+"','"+oData.claimNo+"')\"><i class='fa fa-trash-o fa-lg'></i></a>" };
			            $(nTd).html(txt);
			        } 
	            },
...
// 				{ "data": "updateDate" }, 
		    ...
		    "aoColumnDefs": [
		       		      { "sClass": "text-center", "aTargets": [0,1,2,5,6,7,8,9,10] }
		       		    ],
