...
<%--  ${_SAVE_MODE? '<i class=\'fa fa-user-plus\'></i> Add/Edit': '<i class=\'fa fa-id-card-o\'></i> View'} User Profile  --%>
	 	...
	 	<section class="content">
		   ...
		   <form class="form-horizontal" id="form" action="${cPath}/profile/profileSave.htm" method="post" command="userProfile" data-toggle="validator">
				...
				<div class="row">  
					<div class="col-lg-6">
				  		 ...
				  		 <div class="form-group has-feedback">
			                    ...
			                    <div class="col-lg-6">
			                    	<c:if test="${empty userProfile.userId}">
				              ...
				              <div class="col-lg-6"> 
				                <input  type="password" data-minlength="6" class="form-control" id="inputPassword" name="password" 
				                	data-error="Minimum of 6 characters"    ${not empty param['add']? 'required': ''}>
				                <div class="help-block with-errors"></div>
				              </div>
				            </div>
					...
					<div class="col-lg-6">
						  ...
						  <div class="form-group">
			                    ...
			                    <div class="col-lg-6">
			                       <select  class="form-control selectpicker" id="roleCode" name="roleCode" title="${_PLEASE_SELECT}" disabled multiple required>
		...
		<!-- 	                  </div> -->
					        ...
					        <div class="form-group">
			                    ...
			                    <div class="col-lg-6">
			                     	<select  class="form-control" name="section.section_ID" required disabled >
	                   ...
	                   --%>
			                  ...
			                  <div class="form-group">
			                    ...
			                    <div class="col-lg-6">
			                       <select class="form-control" name="activeFlg" disabled>
...
// 				});
			...
			$("#cancelBtn").click(function(){
				location = cPath+"/profile/userProfile.htm";		
			});
