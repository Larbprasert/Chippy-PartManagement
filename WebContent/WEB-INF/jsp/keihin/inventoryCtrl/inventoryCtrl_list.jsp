				...
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<button type="button"
							...
							<i class="fa fa-plus"></i>  Register New Inventory
						</button>
					</div>
				</div>
...
// 				});
				...
				function doSearch(){
					$.ajax({
			            url: cPath+"/inventoryCtrl/search.json"
...
//			 				});
					...
					columns: [
						...
						{ "data": "inventory_ID" 
							,"render" : function(val, vc , obj) {
								return '<a href="${cPath}/inventoryCtrl/inventoryCtrl_view.htm?inventory_ID='+ obj.inventory_ID +'" >'+obj.inventory_ID+'</a>';
							}
						}, 
						{ "data": "inventory_name" },
						{ "data": "qty"
				...
				function doAdd() {
					location = cPath + "/inventoryCtrl/inventoryCtrl_create.htm" ;
				}
</script>