...
<body class="${bodySkin}">
	...
	<div class="content-wrapper">
		...
		<h1 class="page-header">Request Type List</h1>
		</section> 
				...
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<button type="button"
							...
							<i class="fa fa-plus"></i>  Register New Request Type
						</button>
					</div>
				</div>
...
// 				});
				...
				function doSearch(){
					$.ajax({
			            url: cPath+"/requestType/search.json"
...
//			 				});
					...
					columns: [
						...
						{ "data": "requestType_ID" 
							,"render" : function(val, vc , obj) {
								return '<a href="${cPath}/requestType/requestType_view.htm?requestType_ID='+ obj.requestType_ID +'" >'+obj.requestType_ID+'</a>';
							}
						}, 
				...
				function doAdd() {
					location = cPath + "/requestType/requestType_create.htm" ;
			}
