...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			<i class='fa fa-users'></i> Requisition by month report
		</h1>
	</section>
		   ...
		   <form class="form-horizontal" id="myForm" commandName="userProfile" method="post"> 
		     ...
		     <div class="col-lg-6">
	          	<div class="form-group">
                    ...
                    <div class="col-lg-6">
                       <input type="text" class="form-control" name="productionLine_name" >
                       <input type="Hidden" class="form-control" name="productionLine_ID" >                       
                    </div>
                  </div>
             </div>
	         ...
	         <div class="col-lg-6">
	          	<div class="form-group">
                    <label for="paramCode" class="col-lg-4 control-label">Month</label>
                    <div class="col-lg-6">
			 ...
			 <div class="col-lg-6">
	          ...
	          <div class="col-lg-6">
	          	<div class="form-group">
                    <label for="paramStatus" class="col-lg-4 control-label">Machine</label>
                    <div class="col-lg-6">
