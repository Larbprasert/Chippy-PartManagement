			...
			<div class="col-lg-6">
			    <div class="panel panel-success">
                	...
                	<div class="panel-body">
								...
								<div class="row">
                       			...
                       			<div class="row">
                       				...
                       				<div class="col-lg-8">
                       					<input type="text" class="form-control" placeholder="User Type Name" name="userType_name" value="${userTypeBean.userType_name}" >
                       				</div>	
                       			</div>                			
                       			<br>                       			
                       			<div class="row">
				    ...
				    <div class="panel-footer">
						<input type ="button" value="Save" name="rAction" role="button" class="btn btn-info" onclick="doSaveUserType()">
