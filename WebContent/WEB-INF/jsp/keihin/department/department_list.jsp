...
// 				});
				...
				function doSearch(){
					$.ajax({
			            url: cPath+"/department/search.json"
...
// 						{ "data": "checkTool_ID" }, 
						{ "data": "dept_ID" 
							,"render" : function(val, vc , obj) {
								return '<a href="${cPath}/department/department_view.htm?dept_ID='+ obj.dept_ID +'" >'+obj.dept_ID+'</a>';
							}
						}, 
						{ "data": "dept_name" }, 						 
...
// 						
				...
				function doAdd() {
					location = cPath + "/department/department_create.htm" ;
			}
