                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                       		...
                       		<div class="panel-body">
		                        <div class="row">
                       			...
                       			<div class="row">
                       				...
                       				<div class="col-lg-8">
                       					<input type="text" class="form-control" placeholder="Department Name" name="dept_name" value="${departmentBean.dept_name}" >
                       				</div>	
                       			</div>                       			
                       			<br>                       		
                       			<div class="row">
	                        ...
	                        <div class="panel-footer">
								<input type ="button" value="Save" name="rAction" role="button" class="btn btn-info" onclick="doSaveDepartment()">
